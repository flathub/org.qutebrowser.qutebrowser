...
# make only modules
for _mod in asciidoc pyqt5/{pyqt-builder,pyqt5-sip,python-toml,sip} python-packaging-tools/python-{build,flit-core,installer,packaging,pip517,pyparsing,setuptools-scm,tomli}; do
